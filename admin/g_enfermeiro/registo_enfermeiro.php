        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div style="text-align: center; font-size: large;">Registo de Novo Enfermeiro</div><br><br>

                    <form class="registo_form" id="registo-enfermeiro-form" action="registo_enfermeiro_val.php" method="post">
